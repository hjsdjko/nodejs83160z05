...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="药品编号" prop="yaopinbianhao">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="价格（元）" prop="jiage">
            <el-input v-model.number="ruleForm.jiage" 
                placeholder="价格（元）" clearable :disabled=" false  ||ro.jiage"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="保质期" prop="baozhiqi">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="原材料" prop="yuancailiao">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="原材料"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="药品功效" prop="yaopingongxiao">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="药品功效"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="药品详情" prop="yaopinxiangqing">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/yaopinfenlei/yaopinfenlei', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.yaopinfenleiOptions = res.data.data;
          }
        });
