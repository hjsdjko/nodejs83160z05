<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="药品分类" prop="yaopinfenlei">
					<el-input v-model="ruleForm.yaopinfenlei" placeholder="药品分类" clearable  :readonly="ro.yaopinfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="药品分类" prop="yaopinfenlei">
					<el-input v-model="ruleForm.yaopinfenlei" placeholder="药品分类" readonly></el-input>
				</el-form-item>
			</template>
